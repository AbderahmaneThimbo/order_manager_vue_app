        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr v-for="(detail, index) in orderDetails" :key="index">
                    ...
                    <td>
                        <input type="number" v-model="detail.quantity" class="form-control" placeholder="Quantity"
                            required>
                    </td>
                    <td>
                        <input type="number" step="0.01" v-model="detail.price" class="form-control" placeholder="Price"
                            required>
                    </td>
                    <td>
