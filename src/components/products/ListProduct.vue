<template>
    <div class="container mt-5">
      ...
      <div ><AddProduct @product-added="addProductToList" /></div>
      ...
      <div
        ...
        id="viewproductModal"
        tabindex="-1"
        aria-labelledby="viewproductModalTitle"
        aria-hidden="true"
      >
  ...
  const products = ref([
    {name: "Product 001", description: "High-quality product", price: "100", stock: "10", category: "Electronics", barcode: "123-456-7890", status: "Active" },
    {name: "Product 002", description: "High-quality product", price: "100", stock: "10", category: "Electronics", barcode: "123-456-7890", status: "Active" },
    {name: "Product 003", description: "High-quality product", price: "100", stock: "10", category: "Electronics", barcode: "123-456-7890", status: "Active" },
